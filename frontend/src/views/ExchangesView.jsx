        ...
        <div className="flex items-center gap-2 w-full md:w-auto justify-end">
          {holdingCount > 0 && (
            <button
              ...
              data-tour="exchanges-bulk-restock"
            >
          ...
          <button onClick={() => setShowAddModal(true)} className="btn btn-primary text-xs px-3.5 h-9" data-tour="exchanges-add-btn">
          ...
          <table className="w-full text-left text-xs text-slate-300">
            <thead className="bg-slate-900/90 text-slate-400 font-semibold border-b border-slate-800">
              <tr>
                ...
                <th className="py-3 px-4" data-tour="exchanges-col-returned">Returned SKU</th>
                <th className="py-3 px-4" data-tour="exchanges-col-dispatched">Dispatched SKU</th>
